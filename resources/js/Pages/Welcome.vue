...
<template>
    ...
    <div class="">
        <header class="flex items-center justify-center gap-2 pt-5 bg-black px-20">
            <div class="flex">
        ...
        <main>
            <div class="md:flex bg-black min-h-[20vw] text-white px-24 py-8">
        ...
        <footer class="mt-10 py-10 text-center text-white bg-black font-medium">
