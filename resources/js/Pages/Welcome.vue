...
<template>
    ...
    <div class="">
        <header class="flex items-center justify-center md:py-4 py-3 gap-2 bg-[#111018] px-20">
            <div class="flex">
        ...
        <main>
            <div class="md:flex md:px-24 md:py-16 py-14 px-6  bg-[#111018] min-h-[24vw] text-white ">
                <div class="md:w-1/2 md:flex md:pt-7">
                    <h2 class="md:text-3xl md:font-semibold text-2xl font-medium"><span class="text-[#AD3631]">Lorem ipsum dolor sit amet, consectetur</span> adipiscing elit. Nullam id felis suscipit, tincidunt nulla sed, egestas nisi. Vivamus non sollicitudin orci.</h2>
                </div>
            ...
            <div class="md:mt-14 md:px-24 mt-10 px-6">
                <div>
                    <h2 class="md:mt-10 md:text-3xl text-2xl font-bold text-gray-800">Novo álbum</h2>
                ...
                <div class="md:flex mt-4">
                    <div class="md:w-1/2 md:h-80 h-56 rounded-lg bg-gray-100 ">

                    </div>
                    <!-- Músicas mobile -->
                     <div class="block md:hidden mt-5">
                        <Accordion title="Músicas">
                            <ul>
                        <li
                    ...
                    <div class="md:w-1/2 md:pl-6 md:block hidden">
                        <ul>
                        <li
                            v-for="(track, index) in tracks"
                            :key="index"
            ...
            <div class="md:mt-14 md:px-24 md:py-20 mt-10 px-6 py-12 bg-[#111018] ">
                <h2 class="md:text-3xl text-2xl font-bold text-white">Escute em qualque Lugar</h2>
                <div class="md:flex md:flex-row md:mt-16 md:gap-10 md:justify-center md:space-y-0 md:space-x-0 mt-4 items-center space-x-2 space-y-5 grid grid-cols-2 ">
                    <a href="#" class="self-end">
                        <button type="button" class="md:px-10 md:py-8 md:w-[14rem] md:mb-2 w-full py-6 px-3 text-white text-sm bg-black md:shadow-[0_5px_20px_-5px_rgba(227,227,227,0.3)] shadow-[0_5px_15px_-5px_rgba(227,227,227,0.3)]  hover:before:bg-redborder-red-500 relative text-center inline-flex items-center overflow-hidden  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-black hover:before:left-0 hover:before:w-full rounded-lg">
                            <span class="text-center inline-flex items-center z-10">
                                <svg class="md:w-10 md:h-10 h-8 w-8" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>Spotify-color</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Color-" transform="translate(-200.000000, -460.000000)" fill="#00DA5A"> <path d="M238.16,481.36 C230.48,476.8 217.64,476.32 210.32,478.6 C209.12,478.96 207.92,478.24 207.56,477.16 C207.2,475.96 207.92,474.76 209,474.4 C217.52,471.88 231.56,472.36 240.44,477.64 C241.52,478.24 241.88,479.68 241.28,480.76 C240.68,481.6 239.24,481.96 238.16,481.36 M237.92,488.08 C237.32,488.92 236.24,489.28 235.4,488.68 C228.92,484.72 219.08,483.52 211.52,485.92 C210.56,486.16 209.48,485.68 209.24,484.72 C209,483.76 209.48,482.68 210.44,482.44 C219.2,479.8 230,481.12 237.44,485.68 C238.16,486.04 238.52,487.24 237.92,488.08 M235.04,494.68 C234.56,495.4 233.72,495.64 233,495.16 C227.36,491.68 220.28,490.96 211.88,492.88 C211.04,493.12 210.32,492.52 210.08,491.8 C209.84,490.96 210.44,490.24 211.16,490 C220.28,487.96 228.2,488.8 234.44,492.64 C235.28,493 235.4,493.96 235.04,494.68 M224,460 C210.8,460 200,470.8 200,484 C200,497.2 210.8,508 224,508 C237.2,508 248,497.2 248,484 C248,470.8 237.32,460 224,460" id="Spotify"> </path> </g> </g> </g></svg>
                                <p class="ps-4 text-left">
                                    <span class="text-sm font-light">Escute no:</span><br><span class="">Spotify</span>
                                </p>
                            </span>
                        </button>
                    </a>
                    <a href="#">							
                        <button class="md:px-10 md:py-8 md:w-[14rem] md:mb-2 w-full py-6 px-3 text-white text-sm bg-black md:shadow-[0_5px_20px_-5px_rgba(227,227,227,0.3)] shadow-[0_5px_15px_-5px_rgba(227,227,227,0.3)]  hover:before:bg-redborder-red-500 relative text-center inline-flex items-center overflow-hidden  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-black hover:before:left-0 hover:before:w-full rounded-lg">
                            <span class="text-center inline-flex items-center z-10">
                                <svg class="md:w-10 md:h-10 h-7 w-7 fill-white" xmlns="http://www.w3.org/2000/svg"  aria-label="Apple Music" role="img" viewBox="0 0 512 512"><rect width="512" height="512" rx="15%" fill="url(#g)"/><linearGradient id="g" x1=".5" y1=".99" x2=".5" y2=".02"><stop offset="0" stop-color="#FA233B"/><stop offset="1" stop-color="#FB5C74"/></linearGradient>
                                ...
                                <p class="ps-4 text-left">
                                    <span class="text-sm font-light">Escute no:</span><br><span class="">Apple Music</span>
                                </p>
                            </span>
                        </button>
                    </a>
                    <a href="#">							
                        <button class="md:px-10 md:py-8 md:w-[14rem] md:mb-2 w-full py-6 px-3 text-white text-sm bg-black md:shadow-[0_5px_20px_-5px_rgba(227,227,227,0.3)] shadow-[0_5px_15px_-5px_rgba(227,227,227,0.3)] hover:before:bg-redborder-red-500 relative text-center inline-flex items-center overflow-hidden  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-black hover:before:left-0 hover:before:w-full rounded-lg">
                            <span class="text-center inline-flex items-center z-10">
                                <svg class="md:w-10 md:h-10 h-10 w-10" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                                ...
                                <p class="ps-4 text-left">
                                    <span class="text-sm font-light">Escute no:</span><br><span class="">Youtube</span>
                                </p>
                            </span>
                        </button>
                    </a>
                    <a href="#">
                        <button class="md:px-10 md:py-8 md:w-[14rem] md:mb-2 w-full py-6 px-3 text-white text-sm bg-black md:shadow-[0_5px_20px_-5px_rgba(227,227,227,0.3)] shadow-[0_5px_15px_-5px_rgba(227,227,227,0.3)]  hover:before:bg-redborder-red-500 relative text-center inline-flex items-center overflow-hidden  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-black hover:before:left-0 hover:before:w-full rounded-lg">
                            <span class="text-center inline-flex items-center z-10">
                                <svg class="md:w-10 md:h-10 h-10 w-10" viewBox="0 -11.2 46.9 46.9" id="svg2" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_iconCarrier">
                                ...
                                <p class="ps-4 text-left">
                                    <span class="text-sm font-light">Escute no:</span><br><span class="">Deezer</span>
                                </p>
                            </span>
                        </button>
                    </a>
                    ...
                    <div class="md:w-1/2 md:space-y-8 space-y-5">
                        ...
                        <div class="flex justify-center gap-8">
                            ...
                            <div class="hidden md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-22 p-4 md:flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:mt-3 md:text-normal md:font-bold text-xs font-semibold text-gray-800">Análise</span>
                            </div>
                        </div>
                    </div>
                    <div class="md:w-1/2 md:mt-0 mt-8 text-center">
                        <h3 class="md:font-medium md:text-2xl text-lg font-medium text-gray-800 ">Entre em contato</h3>
                        <p class="md:mt-5 md:text-lg mt-3 tracking-wide text-gray-600 ">Se interessou pelo meu trabalho? Entre em contato e descubra como posso ajudar na mixagem e produção da sua música com qualidade profissional!</p>
                        <div class="flex justify-around mt-6">
                            <div class="flex flex-col items-center text-center">
                                <svg class="md:h-12 md:w-12 h-10 w-10" fill="#000000" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M11.748 5.773S11.418 5 10.914 5c-.496 0-.754.229-.926.387S6.938 7.91 6.938 7.91s-.837.731-.773 2.106c.054 1.375.323 3.332 1.719 6.058 1.386 2.72 4.855 6.876 7.047 8.337 0 0 2.031 1.558 3.921 2.191.549.173 1.647.398 1.903.398.26 0 .719 0 1.246-.385.536-.389 3.543-2.807 3.543-2.807s.736-.665-.119-1.438c-.859-.773-3.467-2.492-4.025-2.944-.559-.459-1.355-.257-1.699.054-.343.313-.956.836-1.031.893-.112.086-.419.365-.763.226-.438-.173-2.234-1.148-3.899-3.426-1.655-2.276-1.837-3.02-2.084-3.824a.56.56 0 0 1 .225-.657c.248-.172 1.161-.933 1.161-.933s.591-.583.344-1.27-1.906-4.716-1.906-4.716z"></path></g></svg>
                                <p class="text-gray-600 text-sm">+55 11 99999-9999</p>
                            </div>
                            <div class="flex flex-col items-center text-center">
                                <svg class="md:h-12 md:w-12 h-10 w-10" xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 24 24"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></g></svg>
                                <p class="text-gray-600 text-sm">mail@mail.com</p>
                            </div>
                        </div>
                        <div class="mt-8">
                            <Link href="/contato" class=" md:px-10 px-16 py-2 font-bold rounded-lg border border-[#AD3631] bg-[#AD3631] text-white hover:text-[#AD3631] hover:bg-transparent transition ease-in-out duration-300">
                                Mais informações
                            </Link>
                        </div>
                    </div>
