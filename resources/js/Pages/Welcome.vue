                    ...
                    <div class="md:w-1/2 md:space-y-8 space-y-5">
                        <div class="flex justify-center gap-8">
                            <div class="md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-full p-4 flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:text-normal md:font-bold text-xs font-semibold text-gray-800 ">Mix & Master</span>
                            </div>
                            <div class="md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-full p-4 flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:text-normal md:font-bold text-xs font-semibold text-gray-800">Produção de música</span>
                            </div>
                        </div>
                        <div class="flex justify-center gap-8">
                            <div class="md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-full p-4 flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:text-normal md:font-bold text-xs font-semibold text-gray-800">Produção e Edição de Áudio</span>
                            </div>
                            <div class="md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-full p-4 flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:text-normal md:font-bold text-xs font-semibold text-gray-800">Assistência em Composição</span>
                            </div>
                            <div class="hidden md:py-6 md:px-2 md:w-36 md:h-36 h-24 w-22 p-4 md:flex flex-col items-center border gap-2  text-center shadow-[0px_4px_10px_rgba(0,0,0,0.3)] rounded-xl">
                                ...
                                <span class="md:text-normal md:font-bold text-xs font-semibold text-gray-800">Análise</span>
                            </div>
                        </div>
                        <div class="flex justify-center gap-8">
