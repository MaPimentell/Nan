...
<template>
    ...
    <div class="">
        ...
        <main>
            ...
            <div class=" bg-white mx-48 -mt-16 px-16 py-8 shadow-lg rounded">
                <div class="">
                    <div>
                        ...
                        <p class="font-medium text-[16px]  text-gray-600">Produção musical, composição, mixagem e muito mais. Seja para um projeto próprio ou uma colaboração, estou aqui para dar vida ao seu som.
                        </p>
                        <div class="mt-6">
                            serviços...
                        </div>
                    ...
                    <div class="flex mt-8">
                        <div class="w-1/2 items-center gap-5">
                            ...
                            <p class="font-medium text-[16px] text-gray-600">Quer saber mais sobre meu trabalho ou iniciar um projeto? Preencha o formulário abaixo ou me chame nas redes sociais. Vou te responder o quanto antes!</p>
                        </div>
